    ...
    },
    {
      ...
      render: (row) =>
        h(
          "span",
          { class: "font-600" },
          formatTransactionMoney(row.trans_amount, row.currency),
        ),
    },
    {
      key: "exchange_rate",
    ...
    },
    {
      ...
      render: (row) =>
        h(
          "span",
          { class: "font-600" },
          formatTransactionMoney(row.local_amount, row.currency),
        ),
    },
    {
      key: "branch",
    ...
    },
    {
      ...
      render: (row) =>
        h(
          "span",
          { class: "font-600" },
          formatTransactionMoney(row.outstanding_amount, row.currency),
        ),
    },
    {
      key: "fully_paid_date",
