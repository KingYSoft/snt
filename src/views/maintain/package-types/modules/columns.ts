...
export function getPackageTypeColumns(
  handleEdit: (row: any) => void,
  handleDelete: (row: any) => void
): DataTableColumns<any> {
  return [
    { key: 'index', title: '#', width: 60, align: 'center', render: (_, index) => index + 1 },
    { key: 'code', title: $t('page.maintain.packageTypes.code'), width: 150, align: 'center' },
    { key: 'desc', title: $t('page.maintain.packageTypes.description'), minWidth: 200 },
    {
      key: 'is_active',
      title: $t('page.maintain.packageTypes.isActive'),
      width: 90,
      align: 'center',
      render(row) {
