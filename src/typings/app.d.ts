      ...
      page: {
        ...
        maintain: {
          ...
          organization: {
            ...
            creditLimit: string;
            tempCreditLimitIncrease: string;
            expiresAt: string;
            agreedPaymentMethod: string;
            creditApprovedBy: string;
            acCreditReviewDue: string;
            arCategory: string;
            externalDebtorCode: string;
            clientNumber: string;
            creditRating: string;
            ...
            company: string;
            branch: string;
            notExistsTitle: string;
            notExistsMessage: string;
            newOrganization: string;
            creditControl: string;
            useSettlementGroupCreditLimit: string;
            arOnCreditHold: string;
            creditApproved: string;
            combinedStatementInvoice: string;
            termsAndOther: string;
            enableArDebtor: string;
            creditDetails: string;
            other: string;
            enableApCreditor: string;
          };
        };
        business: {
          consolidation: {
            ...
            detail: {
              ...
              vgmData: string;
              onBoard: string;
              scheduleAgents: string;
              coloadVgm: string;
              dates: string;
              total: string;
              matchingFillRequired: string;
              shipmentPkMissing: string;
              detachSelectFirst: string;
              saveFailed: string;
            };
            container: {
              containerType: string;
            ...
            billing: {
              ...
              creditor: string;
              dueDate: string;
              invoiceAmtTaxIncl: string;
              invoiceAmtTaxExcl: string;
              transNo: string;
              modifyBy: string;
          ...
          shipment: {
            ...
            messages: {
              ...
              pdfGenerated: string;
              pdfFailed: string;
              billingSaveSuccess: string;
              billingSaveFailed: string;
              edocsNotImplemented: string;
            };
            export: string;
            menu: {
              merge: string;
            ...
            form: {
              ...
              opAtPod: string;
              seaPricing: string;
              opAt1stBookingParty: string;
              opAt2ndBookingParty: string;
              doc: string;
              pricing: string;
              length: string;
              width: string;
