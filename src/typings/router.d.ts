...
declare module 'vue-router' {
  interface RouteMeta {
     ...
     *
     * Checked against grantedPermissions from app config.
     * Matches sjc_vuetify's meta.permissions pattern.
     * If not set, the route is accessible to all authenticated users.
     */
