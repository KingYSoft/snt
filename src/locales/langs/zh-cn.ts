  ...
  page: {
    ...
    settlement: {
      transactions: {
        ...
        transactionNum: '交易号',
        creditorDebtor: '客户/供应商',
        creditorDebtorFullName: '客户/供应商全称',
    ...
    maintain: {
      ...
      organization: {
        ...
        termsAndOther: '条款及其他',
        enableArDebtor: '启用应收 / 债务人',
        creditDetails: '信用详情',
        other: '其他',
        enableApCreditor: '启用应付 / 债权人'
      }
    }
  },
  form: {
