const local: App.I18n.Schema = {
  ...
  route: {
    ...
    "settlement_writeoff-detail": "Match Detail",
    ...
    business: {
      consolidation: {
        ...
        dialog: {
          ...
          notFoundMessage:
            "The requested consolidation does not exist or has been deleted.",
        },
        section: {
          basic: "Basic",
          movement: "Movement",
      ...
      shipment: {
        ...
        dialog: {
          shipmentNotExists: {
            ...
            message:
              "The requested shipment does not exist or has been deleted.",
      ...
      writeoff: {
        ...
        create: {
          ...
          settlementAmountMustBePositive:
            "Selected total must be greater than zero",
          ...
          verificationByFeeDetailsDeveloping:
            "Verification by fee details feature under development",
